...
//		System.out.println(today.getTimeInMillis() / (24*60*60
//				*1000)/365);
//		System.out.println(today.getTimeInMillis() / (24*60*60
//				*1000));
//		
		//시작일과 종료일 지정
		theDay.set(2023,3,16); //시작일지정
...
//				today.get(Calendar.MONTH) + "월" + theDay.get(Calendar.DATE) + "일";		
	//	System.out.println(startDay);
//		System.out.println(today1);
		
		//낥짜 출력 메서드 호출
		System.out.println(datePrint(theDay)); // 시작일 출력
		System.out.println(datePrint(today)); // 시작일 출력
		
		
		
		//지나온 시간 계산
		long passedTime = today.getTimeInMillis() - theDay.getTimeInMillis();
		System.out.println(passedTime+"초");
		// 일로 환산 
	...
	public static String datePrint(Calendar date) { //날짜 객체를 매개로 전달받아서
